    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_id', models.CharField(max_length=4, primary_key=True, serialize=False, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='SystemInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('InTime', models.TimeField(auto_now_add=True, null=True)),
                ('OutTime', models.TimeField(auto_now=True)),
                ('registration_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='systemApp.registration')),
            ],
        ),
    ]
